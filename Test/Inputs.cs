...
namespace Test
{
    public class Inputs
    {
        ...
        public double GetAvgPercentOfAnnualChangeInPayments(int cashFlowYear)
        {
            ...
            double avgPercentOfAnnualChangeInPayments = ((Math.Pow(factor, cashFlowYear) + Math.Pow(factor, cashFlowYear + 1)) / 2); // Calculations should be performed only after all the parameters have been validated
